...
And a union could collapes, which means some types could absorb (or be absorbed bởi) others and there is no way to prevent this absorption. See the following examples:
```ts
